...
<p><b>如何解决：</b>客户端不与系统耦合，外观类与系统耦合。</p>
<p><b>关键代码：</b>在客户端和复杂系统之间再加一层，这一层将调用顺序、依赖关系等处理好。</p>
<p><b>应用实例：</b>
...
<p><b>如何解决：</b>树枝和叶子实现统一接口，树枝内部组合该接口。</p>
<p><b>关键代码：</b>树枝内部组合该接口，并且含有内部属性 List，里面放 Component。</p>
<p><b>应用实例：</b>
